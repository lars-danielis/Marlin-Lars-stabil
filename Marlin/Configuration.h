...
#define E_STEPS_PER_MM ((3200 * 39.0)/(11.0 * 6.75 * 3.142)*100.0/86)
#define Z_MAX_DISTANCE 201.35
...
#define MACHINE_UUID "781d6fc2-ac9c-43e6-a9d1-b716f608864b"
...
#define EXTRUDER_WATTS (12.0*12.0/5.6) //  P=I^2/R
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    ...
    #define  DEFAULT_bedKi 31.85
    #define  DEFAULT_bedKd 670.29
...
#define Z_MAX_POS 201 //(Z_HOME_POS - 0.1)
#define Z_MIN_POS 0
...
#define MANUAL_Z_HOME_POS (Z_MIN_POS ) //Z_MAX_DISTANCE
